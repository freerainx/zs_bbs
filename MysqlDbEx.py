...
class MysqlDbEx:
    ...
    def __init__(self, **config):
        try:
            ...
            raise ValueError("数据库连接失败：" + str(e))
    ...
    # 新增数据
    def insert(self, table_name, value) -> bool:
    ...
    def update(self, table_name, val_obl, change_str) -> bool:
    ...
    # 删除数据
    def delete(self, table_name, item) -> bool:
